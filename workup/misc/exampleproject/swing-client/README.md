...
mvn clean install
cd target
java -jar exampleproject-swing-client-swing-client-0.2-SNAPSHOT.one-jar.jar

```

You can also supply a local properties file 
```
java -jar exampleproject-swing-client-swing-client-0.2-SNAPSHOT.one-jar.jar -p <path to config.properties>
```
