...
import solent.ac.uk.ood.examples.swingcient.ThingListTableModel;
...
public class ControlsJPanel extends javax.swing.JPanel {
    ...
    public ControlsJPanel(ModelController modelController) {
        ...
        thingListTableModel = modelController.getThingListTableModel();
        initComponents();

        jTable1.setModel(thingListTableModel);
        ...
        jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent event) {
                ...
                String thingIdstr = jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString();
                LOG.debug("table row selected :" + thingIdstr);
                ...
                thing.setField_A(field_A);
                thing.setField_B(field_B);
                thing.setField_C(field_C);
                try {
                    thing.setId(Integer.parseInt(thingIdstr));
                } catch (NumberFormatException ex) {

                }
                thingFieldsJPanel1.setModelThing(thing);
    ...
    /**
     * Creates new form ThingListJPanel
     */
    ...
    private void initComponents() {
        ...
        thingFieldsJPanel1 = new solent.ac.uk.ood.examples.swingcient.gui.ThingFieldsJPanel();
        ...
        jPanel1.add(thingFieldsJPanel1);
    ...
    private void clearSearchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearSearchButtonActionPerformed
        ...
        Thing templateThing = new Thing();
        thingFieldsJPanel1.setModelThing(templateThing);
        ...
        SwingWorker worker = new SwingWorker<String, Void>() {
            ...
            public String doInBackground() {
                ...
                m_modelController.findMatchingSearch(templateThing);
                return null;
            }
    ...
    private void findMatchingButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findMatchingButtonActionPerformed
        ...
        Thing templateThing = thingFieldsJPanel1.getModelThing();
        jTable1.clearSelection();
        // running query in seperate thread 
        SwingWorker worker = new SwingWorker<String, Void>() {
            @Override
    ...
    private solent.ac.uk.ood.examples.swingcient.gui.ThingFieldsJPanel thingFieldsJPanel1;
