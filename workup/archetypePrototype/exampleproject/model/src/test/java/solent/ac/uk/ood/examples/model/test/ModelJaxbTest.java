 ...
 *
 ****************************************************************************/
package solent.ac.uk.ood.examples.model.test;
...
public class ModelJaxbTest {
    ...
    public void testJaxb() {
        ...
        try {
            ...
            JAXBContext jaxbContext = JAXBContext.newInstance("solent.ac.uk.ood.examples.model");
            ...
            List<Thing> things = replyMessage1.getThingList().getThings();
