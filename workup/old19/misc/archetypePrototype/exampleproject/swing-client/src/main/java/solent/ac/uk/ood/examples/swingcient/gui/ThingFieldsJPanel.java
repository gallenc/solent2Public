 ...
 * @author cgallen
 */
public class ThingFieldsJPanel extends javax.swing.JPanel {

    private static final Logger LOG = LoggerFactory.getLogger(ThingFieldsJPanel.class);

    private Thing modelThing = new Thing();

    public Thing getModelThing() {

        if ("".equals(jTextField_A.getText())) {
            this.modelThing.setField_A(null);
        } else {
            this.modelThing.setField_A(jTextField_A.getText());
        }

        if ("".equals(jTextField_B.getText())) {
            this.modelThing.setField_B(null);
        } else {
            this.modelThing.setField_B(jTextField_B.getText());
        }

        if ("".equals(jTextField_C.getText())) {
            this.modelThing.setField_C(null);
        } else {
            this.modelThing.setField_C(jTextField_C.getText());
        }

        String intText = jTextField_id.getText();
        try {
            Integer id = Integer.parseInt(intText);
            this.modelThing.setId(id);
    ...
    public void setModelThing(Thing modelThing) {
        LOG.debug("setting model thing to " + modelThing);
        this.modelThing = modelThing;
        jTextField_A.setText(this.modelThing.getField_A());
        jTextField_B.setText(this.modelThing.getField_B());
        jTextField_C.setText(this.modelThing.getField_C());

        String idtxt = (modelThing.getId() == null) ? null : modelThing.getId().toString();
    ...
    /**
     * Creates new form ThingFieldsJPanel
     */
    public ThingFieldsJPanel() {
        initComponents();
    }
    ...
    private void jTextField_idActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField_idActionPerformed
        ...
        try {
            ...
            this.modelThing.setId(null); // should not happen because checked 
        }
