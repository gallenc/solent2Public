 ...
 *
 ****************************************************************************/
package solent.ac.uk.ood.examples.hotellock.model.test;
...
public class ModelJaxbTest {
    ...
    public void testJaxb() {
        ...
        try {
            ...
            cardkey.setEndDate(new Date());
            cardkey.setRoomNumber("101");
            cardkey.setIssueNumber(1);
            restMessage.setCardkey(cardkey);
            restMessage.setUnlocked(Boolean.FALSE);
            restMessage.setCardCode("10101010101010101010");

            // marshal the object lists to system out, a file and a stringWriter
            jaxbMarshaller.marshal(restMessage, System.out);
            jaxbMarshaller.marshal(restMessage, file);

            // string writer is used to compare received object
            StringWriter sw1 = new StringWriter();
            jaxbMarshaller.marshal(restMessage, sw1);
            ...
            jaxbMarshaller.marshal(receivedRestMessage, sw2);
