...
In addition to JAXB, if we include the Jackson library on our class path it allows JAX-RS to also marshalled and unmarshalled JAXB XML objects as Json messages.
