...
public class AnimalObjectFactorySpringTest {
    ...
    public void testCreateCat() {
        Animal animal1 = AnimalObjectFactory.createCat();
        ...
        Animal animal2 = AnimalObjectFactory.createDog();
    ...
    public void testCreateDog() {
        Animal animal1 = AnimalObjectFactory.createDog();
        assertNotNull(animal1);
    ...
    public void testCreateCow() {
        Animal animal1 = AnimalObjectFactory.createCow();
        assertNotNull(animal1);
    ...
    public void testCreateFarmFacade() {
        FarmFacade farmFacade1 = AnimalObjectFactory.getFarmFacade();
        assertNotNull(farmFacade1);
        
        FarmFacade farmFacade2 = AnimalObjectFactory.getFarmFacade();
