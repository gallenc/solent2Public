...
public class ExampleCollectionsTest {
    ...
    // in this case we are using an ArrayList implementation which is a list implemented using an array
    ...
    // you could alternatively use a Linked list implementation to do the same thing
    List unTypedList2 = new LinkedList();
    List<Animal> listOfAnimals2 = new LinkedList<Animal>();

    // Map is a collection of objects with name, variable mapping
    // HashMap is backed with a Hash Table 
    // see https://en.wikipedia.org/wiki/Hash_table 
    // a HashTable is an associative array of name value pairs
