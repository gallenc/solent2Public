...
## Simple ReST example
Lets start with a simple ReST example. This code is in SimpleRestExample.java
...
The ReST code in SimpleRestExample.java is activated by the RestApp.java (which I describe further below). 
